...
@available(iOS 13.0, *)
public class LFScreenShieldView: UIView {
    var stextField: UITextField?
    
    @objc
    public static func create(frame: CGRect = .zero) -> LFScreenShieldView {
        return LFScreenShieldView(frame: frame)
    }
    ...
    private override init(frame: CGRect) {
        ...
        if let sf = safeZone {
            ...
            let top_ = NSLayoutConstraint.init(item: sf, attribute: .top, relatedBy: .equal, toItem: self, attribute: .top, multiplier: 1, constant: 0)
            let bottom_ = NSLayoutConstraint.init(item: sf, attribute: .bottom, relatedBy: .equal, toItem: self, attribute: .bottom, multiplier: 1, constant: 0)
            let leading_ = NSLayoutConstraint.init(item: sf, attribute: .leading, relatedBy: .equal, toItem: self, attribute: .leading, multiplier: 1, constant: 0)
            let trailing_ = NSLayoutConstraint.init(item: sf, attribute: .trailing, relatedBy: .equal, toItem: self, attribute: .trailing, multiplier: 1, constant: 0)
            
            self.addConstraints([top_, bottom_, leading_, trailing_])
        }
    }
    ...
    private func makeSecureView() -> UIView? {
        ...
        let errorMsg = "[LFScreenShieldView log] Create safeZone failed!"
#if DEBUG
